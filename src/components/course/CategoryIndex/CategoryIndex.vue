<template>
    <div class="category-index-wrapper shadow-2">
        <div class="category-index-title">
            <router-link class="black-link no-underline" to="/">
        ...
        <div class="category-index-content">
            <ul class="category-main-menu elevation-4">
                <li class="category-main-menu-item" v-for="(firstLevel,firstIndex) in courseCategoryItems" :key="firstIndex">
                    ...
                    <div class="category-menu-aside elevation-6" v-if="firstLevel.children"
                        ...
                        <ul>
                            <li v-for="(secondLevel,secondIndex) in firstLevel.children" :key="secondIndex">
                                <div class="category-aside-title">
                                    <router-link to="/" class="black-link no-underline">
                                ...
                                <div class="category-aside-content" v-if="secondLevel.children">
                                    <template v-for="thirdLevel in secondLevel.children">
                                        <!--<span :key="thirdIndex"></span>-->
                                        <a class="black-link no-underline" >
                                            {{thirdLevel.title}}
                                        </a>
                                    </template>
...
<script lang="ts">
    ...
    export default class CategoryIndex extends Vue {
        ...
        // 此处可以用created、mounted等，也可以写在NavBar、Main组件中！！！！！！重点，卡了好久啊！！！
        created(){
...
@import "../../../assets/theme/theme";
    ...
    .category-index-wrapper{
        ...
        z-index: 100;
        padding: 0 1rem;
        /*同时设置height和line-height相同，可以将内容文字垂直居中*/
        height: $navHeight;
        ...
        &:hover{
            ...
            .category-index-content{
                opacity: 1;
                visibility: visible;
                transition: opacity .5s ease $transition-delay;
            }
        }
    }
